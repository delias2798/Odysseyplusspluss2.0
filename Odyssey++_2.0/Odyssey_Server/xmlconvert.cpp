...
QString xmlConvert::xmlTrack(QString user_, QString album_, QString artist_, QString genre_, QString letter_, QString title_, QString year_, QString dir_, QString rate_)
{
    QDomDocument doc;
    QDomProcessingInstruction instr = doc.createProcessingInstruction("xml", "version='1.0' encoding='UTF-8'");
    doc.appendChild(instr);
    ...
    QDomElement h = doc.createElement("path");
    QDomText dir = doc.createTextNode(dir_);

    QDomElement i = doc.createElement("rate");
    QDomText rate = doc.createTextNode(rate_);
...
QString xmlConvert::xmlTrack2(QString user_, QString letter_, QString title_, QString dir_, QString rate_)
{
    QDomDocument doc;
    QDomProcessingInstruction instr = doc.createProcessingInstruction("xml", "version='1.0' encoding='UTF-8'");
    doc.appendChild(instr);
